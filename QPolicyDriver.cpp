...
const int QPolicyDriver::gearUp[6]=
    {
        5000,6000,6000,6500,7000,0
    };
const int QPolicyDriver::gearDown[6]=
    {
        0,2500,3000,3000,3500,3500
    };

/* Stuck constants*/
const int QPolicyDriver::stuckTime = 25;
const float QPolicyDriver::stuckAngle = .523598775; //PI/6

/* Accel and Brake Constants*/
const float QPolicyDriver::maxSpeedDist=70;
const float QPolicyDriver::maxSpeed=150;
const float QPolicyDriver::sin5 = 0.08716;
const float QPolicyDriver::cos5 = 0.99619;

/* Steering constants*/
const float QPolicyDriver::steerLock=0.366519 ;
const float QPolicyDriver::steerSensitivityOffset=80.0;
const float QPolicyDriver::wheelSensitivityCoeff=1;

/* ABS Filter Constants */
const float QPolicyDriver::wheelRadius[4]={0.3306,0.3306,0.3276,0.3276};
const float QPolicyDriver::absSlip=2.0;
const float QPolicyDriver::absRange=3.0;
const float QPolicyDriver::absMinSpeed=3.0;

/* Clutch constants */
const float QPolicyDriver::clutchMax=0.5;
const float QPolicyDriver::clutchDelta=0.05;
const float QPolicyDriver::clutchRange=0.82;
const float QPolicyDriver::clutchDeltaTime=0.02;
const float QPolicyDriver::clutchDeltaRaced=10;
const float QPolicyDriver::clutchDec=0.01;
const float QPolicyDriver::clutchMaxModifier=1.3;
const float QPolicyDriver::clutchMaxTime=1.5;
...
int getBestActionId(const pair<int,int>& state)
{
	...
	{
		if(Q[state][i].first > bestUtility)
		{
...
int
QPolicyDriver::getGear(CarState &cs)
{
...
float
QPolicyDriver::getSteer(CarState &cs)
{
...
float
QPolicyDriver::getAccel(CarState &cs)
{
...
CarControl
QPolicyDriver::wDrive(CarState cs)
{
	iterationCount++;
...
float
QPolicyDriver::filterABS(CarState &cs,float brake)
{
...
void
QPolicyDriver::clutching(CarState &cs, float &clutch)
{
...
void
QPolicyDriver::init(float *angles)
{
	cout<< "Init function\n";
